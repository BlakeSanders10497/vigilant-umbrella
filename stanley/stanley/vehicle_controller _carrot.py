...
print_cross_track = True
outfile = open('point_at_carrot_output.csv', 'w')
print('cross track error (m), heading error (rad)', file = outfile)

class VehicleController(Node):
    def __init__(self):
        super().__init__("vehicle_controller_carrot")
    ...
    def main_timer_callback(self):
        ...
        self.get_logger().info(f"callback is running!")
